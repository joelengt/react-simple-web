...
var Cluster = (function (_super) {
    ...
    function Cluster() {
        ...
        _this.getLeaves = function (feature, zoom) {
            var superC = _this.state.superC;
            return superC.getLeaves(feature.properties.cluster_id, zoom).map(function (leave) { return _this.featureClusterMap.get(leave); });
        };
        return _this;
    }
    ...
    Cluster.prototype.render = function () {
        ...
        return (React.createElement("div", null, clusterPoints.map(function (feature) {
            if (feature.properties.cluster) {
                return ClusterMarkerFactory(feature.geometry.coordinates, feature.properties.point_count, _this.getLeaves.bind(_this, feature, zoom));
            }
